import type { Lv4Chat, Lv4Contact } from '../types'

/**
 * Lv.4 聊天列表数据 — 与设计稿 chat-list.html 完全一致
 * （测试家庭群、前端技术交流群、项目协作群、智能助手Pro 等 10 条）。
 * 文件传输助手作为聊天详情页默认内容（连接列表与详情）。
 */
export const initialLv4Chats: Lv4Chat[] = [
  {
    id: 'file-transfer',
    name: '文件传输助手',
...
/** 通讯录联系人（与设计稿 contacts.html 的 A/B/C 分组一致），关联聊天 id 以打通「发消息」 */
export const initialLv4Contacts: Lv4Contact[] = [
